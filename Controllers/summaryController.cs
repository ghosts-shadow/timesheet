...
namespace onlygodknows.Controllers
{
    ...
    public class summaryController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (uid1.csid != 0 && !(this.User.IsInRole("Admin") || this.User.IsInRole("Head_of_projects(citiscape)") || this.User.IsInRole("Head_of_projects(grove)") || this.User.IsInRole("HR_manager") || this.User.IsInRole("logistics_officer") || this.User.IsInRole("Admin_View")))
            {
